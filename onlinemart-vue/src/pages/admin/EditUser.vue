<template>
  <div class="EditUser">
  	<header class="clear">
  		<span>用户管理</span>
      <div>
        <input ref="input" type="text" placeholder="输入搜索用户昵称" />
        <button @click="searchUser"><i class="iconfont icon-search" /></button>
      </div>

<!--      <div style="margin-right: 20px">-->
<!--        <input ref="inputEmail" type="text" placeholder="输入搜索用户email" />-->
<!--        <button></button>-->
<!--      </div>-->
  	</header>
	<table className="userTable">
        <thead>
        	<tr><th>ID</th><th>昵称</th><th>收件人</th><th>收货地址</th><th>联系电话</th><th>操作</th></tr>
        </thead>
        <tbody>
